...
- `npx storybook@latest automigrate --config-dir packages/react/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir packages/angular/.storybook --renderer @storybook/angular`
